...
theme: /
    ...
    state: Старт || sessionResult = "Сценарий начинается отсюда", sessionResultColor = "#143AD1"
        ...
        inlineButtons:
            {text: "Логи", url: ""},
            {text: "Чат-бот", url: "https://www.figma.com/board/H5vFjabULhexaG3jzTHKOb/%D0%97%D0%B0%D0%BF%D0%B8%D1%81%D0%B8-%D0%9C%D0%A4%D0%A6?node-id=0-1&t=lb71pWj8mtwO2svJ-1"},
